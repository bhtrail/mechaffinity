...
public class BaseEffectManager
{
    ...
    protected List<PilotDelayedEffects> delayedEffectsList = new();
    private List<AbstractActor> spawnedActors = new();
    ...
    {
        List<PilotDelayedEffects> delayedEffectsFromActor = new();
